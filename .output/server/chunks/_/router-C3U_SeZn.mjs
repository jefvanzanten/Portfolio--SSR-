import { ssr, ssrHydrationKey, ssrStyleProperty, createComponent as createComponent$1, NoHydration, escape, HydrationScript, ssrAttribute, mergeProps as mergeProps$1, Dynamic as Dynamic$1, isServer, ssrElement, spread as spread$1, useAssets } from "solid-js/web";
import * as Solid from "solid-js";
import { Suspense, For as For$1, Show as Show$1, createSignal as createSignal$1, createEffect as createEffect$1, onMount, createResource as createResource$1, createContext as createContext$1, sharedConfig as sharedConfig$1, onCleanup as onCleanup$1, createUniqueId as createUniqueId$1, useContext as useContext$1, createRenderEffect as createRenderEffect$1 } from "solid-js";
...
const Link$1 = (props) => {
  ...
  const children2 = Solid.createMemo(() => {
  ...
  if (local._asChild === "svg") {
    ...
    return ssr(_tmpl$$4, ssrHydrationKey(), ssrElement("a", svgLinkProps, () => escape(children2()), false));
  }
  return createComponent$1(Dynamic$1, mergeProps$1({
    get component() {
...
let Route$3 = class Route extends BaseRoute {
  ...
  constructor(options) {
    ...
    this.Link = (props) => {
      const _self$ = this;
      return createComponent$1(Link$1, mergeProps$1({
        get from() {
...
function lazyRouteComponent(importer, exportName) {
  ...
  const lazyComp = function Lazy(props) {
    ...
    if (!comp) {
      const [compResource] = createResource$1(load, {
        initialValue: comp,
        ssrLoadFrom: "initial"
      });
      return createComponent$1(Dynamic$1, mergeProps$1({
...
function useHead(tagDesc) {
  const c = useContext$1(MetaContext);
  if (!c) throw new Error("<MetaProvider /> should be in the tree");
  createRenderEffect$1(() => {
    const index = c.addTag(tagDesc);
    onCleanup$1(() => c.removeTag(tagDesc, index));
  });
}
...
function Asset({
  ...
  switch (tag) {
    case "title":
      return createComponent$1(Title, mergeProps$1(attrs, {
        children: children2
      }));
    case "meta":
      return createComponent$1(Meta, attrs);
    case "link":
      return createComponent$1(Link, attrs);
    case "style":
      return createComponent$1(Style, mergeProps$1(attrs, {
        innerHTML: children2
      }));
    case "script":
      return createComponent$1(Script, {
        attrs,
        children: children2
      });
    default:
...
function Script({
  ...
  if (typeof children2 === "string") {
    return ssrElement("script", mergeProps$1(attrs, {
      innerHTML: children2
    }), void 0, true);
  }
  return null;
...
function HeadContent() {
  ...
  return createComponent$1(MetaProvider, {
    get children() {
      return createComponent$1(For$1, {
        get each() {
          return tags();
        },
        children: (tag) => createComponent$1(Asset, tag)
      });
    }
  });
}
...
const Scripts = () => {
  ...
  return allScripts.map((asset, i) => createComponent$1(Asset, asset));
};
const sharedConfig = {
  context: void 0,
  registry: void 0,
  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-DymJEvfG-Ba4EKe6_.mjs"));
  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-BBz1qLry-BDvDsBie.mjs").then((n) => n.d).then((n) => n.c));
...
var _tmpl$$3 = ["<div", "></div>"];
const TanStackRouterDevtools$1 = (props) => {
  ...
  const [devtools] = createSignal$1(new TanStackRouterDevtoolsCore(usedProps));
  createEffect$1(() => {
...
const TanStackRouterDevtoolsPanel = (props) => {
  ...
  const [devtools] = createSignal$1(new TanStackRouterDevtoolsPanelCore(usedProps));
  createEffect$1(() => {
    devtools().setRouter(usedProps.router);
  });
  createEffect$1(() => {
...
var _tmpl$$1 = ["<div", ' id="modal"', "><header", '><a href="#"', ' title="close">✕</a></header><img', ' alt="Project cover"></div>'];
const [isModalOpen, setIsModalOpen] = createSignal$1(false);
const [modalImgUrl, setModalImgUrl] = createSignal$1("");
function ImageViewModal() {
  return createComponent$1(Show$1, {
    ...
    get children() {
      return ssr(_tmpl$$1, ssrHydrationKey(), ssrAttribute("class", escape(styles.dialog, true), false), ssrAttribute("class", escape(styles.header, true), false), ssrAttribute("class", escape(styles["close-button"], true), false), ssrAttribute("src", escape(modalImgUrl(), true), false) + ssrAttribute("class", escape(styles.image, true), false));
    }
  });
}
...
function RootComponent() {
  return ssr(_tmpl$2, ssrHydrationKey(), ssrStyleProperty("background-color:", "#0a0a0a"), createComponent$1(NoHydration, {
    get children() {
      return ssr(_tmpl$, escape(createComponent$1(HydrationScript, {})));
    }
  }), ssrStyleProperty("background-color:", "#0a0a0a") + ssrStyleProperty(";color:", "white"), escape(createComponent$1(HeadContent, {})), escape(createComponent$1(Suspense, {
    get children() {
      return [createComponent$1(Outlet, {}), createComponent$1(ImageViewModal, {}), createComponent$1(TanStackRouterDevtools, {})];
    }
  })), escape(createComponent$1(Scripts, {})));
}
const $$splitComponentImporter$1 = () => import("./index-hFDQfA7v.mjs");
const Route$1 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-4woIce4s.mjs");
