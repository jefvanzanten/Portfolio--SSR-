...
import { u as useProjects, P as ProjectCard } from "./ProjectCard-obFJNOSE.mjs";
import "./router-lSxH-c65.mjs";
import "./server.mjs";
...
const container$1 = "_container_evd5n_1";
const legend = "_legend_evd5n_35";
const libraries = "_libraries_evd5n_45";
const libraryGroup = "_libraryGroup_evd5n_59";
const fieldset = "_fieldset_evd5n_73";
const item = "_item_evd5n_85";
const styles = {
...
const FilterMenu = (props) => {
  ...
  return ssr(_tmpl$$2, ssrHydrationKey() + ssrAttribute("class", escape(styles.container, true), false), ssrAttribute("class", escape(styles.fieldset, true), false), ssrAttribute("class", escape(styles.legend, true), false), ssrAttribute("class", escape(styles.libraryGroup, true), false), ssrAttribute("class", escape(styles.item, true), false), ssrAttribute("checked", props.selectedLanguages.includes("TypeScript"), true), ssrAttribute("class", escape(styles.item, true), false), ssrAttribute("checked", props.selectedLanguages.includes("Kotlin"), true), ssrAttribute("class", escape(styles.item, true), false), ssrAttribute("checked", props.selectedLanguages.includes("Java"), true), ssrAttribute("class", escape(styles.item, true), false), ssrAttribute("checked", props.selectedLanguages.includes("CSS"), true), ssrAttribute("class", escape(styles.libraries, true), false), ssrAttribute("class", escape(styles.legend, true), false), ssrAttribute("class", escape(styles.libraryGroup, true), false), ssrAttribute("class", escape(styles.item, true), false), ssrAttribute("checked", props.selectedLibraries.includes("React"), true), ssrAttribute("class", escape(styles.item, true), false), ssrAttribute("checked", props.selectedLibraries.includes("TailwindCSS"), true), ssrAttribute("class", escape(styles.item, true), false), ssrAttribute("checked", props.selectedLibraries.includes("React-Router"), true), ssrAttribute("class", escape(styles.item, true), false), ssrAttribute("checked", props.selectedLibraries.includes("TanStackQuery"), true), ssrAttribute("class", escape(styles.libraryGroup, true), false), ssrAttribute("class", escape(styles.item, true), false), ssrAttribute("checked", props.selectedLibraries.includes("Nextjs"), true), ssrAttribute("class", escape(styles.item, true), false), ssrAttribute("checked", props.selectedLibraries.includes("Express"), true), ssrAttribute("class", escape(styles.item, true), false), ssrAttribute("checked", props.selectedLibraries.includes("Drizzle"), true), ssrAttribute("class", escape(styles.item, true), false), ssrAttribute("checked", props.selectedLibraries.includes("Better-Auth"), true), ssrAttribute("class", escape(styles.libraryGroup, true), false), ssrAttribute("class", escape(styles.item, true), false), ssrAttribute("checked", props.selectedLibraries.includes("React-Native"), true), ssrAttribute("class", escape(styles.item, true), false), ssrAttribute("checked", props.selectedLibraries.includes("JetpackCompose"), true), ssrAttribute("class", escape(styles.item, true), false), ssrAttribute("checked", props.selectedLibraries.includes("JavaFX"), true));
};
