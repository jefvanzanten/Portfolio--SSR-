import { ssr, ssrHydrationKey, ssrStyleProperty, createComponent, NoHydration, escape, HydrationScript, mergeProps, Dynamic, isServer, ssrElement, spread, useAssets } from "solid-js/web";
import * as Solid from "solid-js";
import { lazy, For, createResource, createContext, sharedConfig, onMount, onCleanup, createUniqueId, useContext, createRenderEffect } from "solid-js";
import { R as RouterCore, O as Outlet, w as warning, u as useRouter, a as useRouterState, h as isModuleNotFoundError, g as dummyMatchContext, m as matchContext, i as invariant, r as rootRouteId, t as trimPathLeft, j as joinPaths, e as exactPathTest, c as removeTrailingSlash, d as deepEqual$1, b as useIntersectionObserver, f as functionalUpdate } from "./server.mjs";
...
const ImageViewModal = lazy(() => import("./ImageViewModal-BConQU4V.mjs"));
