import { c as createSignal, a as createEffect, e as createRenderEffect, u as useContext, k as useDevtoolsOnClose, l as untrack, b as createMemo, t as template, s as spread, m as mergeProps, i as insert, n as addEventListener, f as className, d as createComponent, o as memo, M as Match, j as setAttribute, F as For, S as Switch, p as Show, q as onCleanup, r as ShadowDomTargetContext, v as delegateEvents } from "./router-C3U_SeZn.mjs";
import { i as invariant, r as rootRouteId, k as trimPath, l as interpolatePath } from "./server.mjs";
import "solid-js/web";
import "solid-js";
...
function multiSortBy(arr, accessors = [(d) => d]) {
  return arr.map((d, i2) => [d, i2]).sort(([a2, ai], [b, bi]) => {
...
function RouteComp({
  ...
  return (() => {
    ...
    insert(_el$6, (() => {
      ...
      return () => _c$() ? (() => {
        var _el$10 = _tmpl$6();
        insert(_el$10, () => [...route.children].sort((a2, b) => {
...
const BaseTanStackRouterDevtoolsPanelBBz1qLry = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  B: BaseTanStackRouterDevtoolsPanel,
  a: useIsMounted,
  b: useStyles$1,
  c: BaseTanStackRouterDevtoolsPanel$1,
  u: useLocalStorage
}, Symbol.toStringTag, { value: "Module" }));
export {
  ...
  useStyles$1 as b,
  clsx as c,
  BaseTanStackRouterDevtoolsPanelBBz1qLry as d,
